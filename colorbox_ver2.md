Cách làm:
Css: Copy rồi cho vào kiểu dáng
...
$(function(){$(".content").each(function(index){$(this).find("a").attr("rel",index);});$(".content").find("a[href*='.png'], a[href*='.gif'], a[href*='.jpg'], a[href*='.jpeg'], a[href*='.bmp']").colorbox({slideshow:true});});
