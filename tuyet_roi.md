...
<script type="text/javascript">$(function(){$("body").append('<img src="http://i.imgur.com/duHDQ.png" style="position:absolute; top: 0px;left:0px;border:none;"/><img id="xmasleftbell" src="http://i.imgur.com/PAhbI.png" style="position:absolute; top: 0px;right:0px;border:none;"/>');});

Unknown end tag for &lt;/script&gt;


<script src="http://songoku.sforum.biz/h1-page">
...
$(function(){$("body").append('<img src="http://i.imgur.com/duHDQ.png" style="position:absolute; top: 0px;left:0px;border:none;"/><img id="xmasleftbell" src="http://i.imgur.com/PAhbI.png" style="position:absolute; top: 0px;right:0px;border:none;"/>');});

$(function(){$(document).snowfall({flakeCount:150});});```