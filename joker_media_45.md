...
"});$('a[href^="http://tv.zing.vn/video"]').each(function(){$(this).replaceWith('<if'+'rame width="450" height="285" src="http://tv.zing.vn/embed/video/'+ getIDtvzing($(this).attr("href")) +'" frameborder="0" allowfullscreen="true"> </if'+'rame>');});});
