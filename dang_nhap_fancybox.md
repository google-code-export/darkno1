...
<div id="funybox" style="left: 0px; display: none; "><div id="loginbox"><div><div><strong>Đăng nhập

Unknown end tag for &lt;/strong&gt;

<span><a href="javascript:displaymenu('#funybox','detrik')" title="Cerrar">x
...
<form action="/ucp.php?mode=login" method="post" name="form_login"><div><label for="username">Tên đăng nhập

Unknown end tag for &lt;/label&gt;

<br><input id="quick_login_username" name="username" type="text">

Unknown end tag for &lt;/div&gt;

<div><label for="password">Mật khẩu

Unknown end tag for &lt;/label&gt;

 <input id="quick_login_password" name="password" type="password"><span><a href="/ucp.php?mode=sendpassword" id="resend_password_link">Quên mật khẩu
...
<br><div><input type="checkbox" name="autologin" id="autologin" tabindex="4" checked="checked"><label>Ghi nhớ
...
<div><input id="signin_submit_remember" name="login" type="submit" value="Đăng nhập">
...
<div id="rep-mail-bar"><div><a href="/ucp.php?mode=register"><img src="http://i30.servimg.com/u/f30/17/60/71/24/ky10.png" title="Đăng ký">

Unknown end tag for &lt;/a&gt;

  <a href="javascript:displaymenu('#funybox','center')"><img src="http://i30.servimg.com/u/f30/17/60/71/24/login10.png" title="Đăng nhập">
...
<script>jQuery(document).ready( function() {jQuery(".NAMBUSER15").load("/ucp.php?mode=editprofile&page_profil=avatars #pun-visit p strong");});
